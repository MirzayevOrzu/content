...
- {{cssxref("transform-function/matrix", "transform-function/matrix()", "matrix()")}}
  - : Describes a homogeneous 2D transformation matrix.
- {{cssxref("transform-function/matrix3d", "transform-function/matrix3d()", "matrix3d()")}}
  - : Describes a 3D transformation as a 4×4 homogeneous matrix.
- {{cssxref("transform-function/perspective", "transform-function/perspective()", "perspective()")}}
  - : Sets the distance between the user and the z=0 plane.
- {{cssxref("transform-function/rotate", "transform-function/rotate()", "rotate()")}}
  - : Rotates an element around a fixed point on the 2D plane.
- {{cssxref("transform-function/rotate3d", "transform-function/rotate3d()", "rotate3d()")}}
  - : Rotates an element around a fixed axis in 3D space.
- {{cssxref("transform-function/rotateX", "transform-function/rotateX()", "rotateX()")}}
  - : Rotates an element around the horizontal axis.
- {{cssxref("transform-function/rotateY", "transform-function/rotateY()", "rotateY()")}}
  - : Rotates an element around the vertical axis.
- {{cssxref("transform-function/rotateZ", "transform-function/rotateZ()", "rotateZ()")}}
  - : Rotates an element around the z-axis.
- {{cssxref("transform-function/scale", "transform-function/scale()", "scale()")}}
  - : Scales an element up or down on the 2D plane.
- {{cssxref("transform-function/scale3d", "transform-function/scale3d()", "scale3d()")}}
  - : Scales an element up or down in 3D space.
- {{cssxref("transform-function/scaleX", "transform-function/scaleX()", "scaleX()")}}
  - : Scales an element up or down horizontally.
- {{cssxref("transform-function/scaleY", "transform-function/scaleY()", "scaleY()")}}
  - : Scales an element up or down vertically.
- {{cssxref("transform-function/scaleZ", "transform-function/scaleZ()", "scaleZ()")}}
  - : Scales an element up or down along the z-axis.
- {{cssxref("transform-function/skew", "transform-function/skew()", "skew()")}}
  - : Skews an element on the 2D plane.
- {{cssxref("transform-function/skewX", "transform-function/skewX()", "skewX()")}}
  - : Skews an element in the horizontal direction.
- {{cssxref("transform-function/skewY", "transform-function/skewY()", "skewY()")}}
  - : Skews an element in the vertical direction.
- {{cssxref("transform-function/translate", "transform-function/translate()", "translate()")}}
  - : Translates an element on the 2D plane.
- {{cssxref("transform-function/translate3d", "transform-function/translate3d()", "translate3d()")}}
  - : Translates an element in 3D space.
- {{cssxref("transform-function/translateX", "translateX()")}}
  - : Translates an element horizontally.
- {{cssxref("transform-function/translateY", "transform-function/translateY()", "translateY()")}}
  - : Translates an element vertically.
- {{cssxref("transform-function/translateZ", "transform-function/translateZ()", "translateZ()")}}
...
- {{cssxref("filter-function/blur", "filter-function/blur()", "blur()")}}
  - : Blurs the image.
- {{cssxref("filter-function/brightness", "filter-function/brightness()", "brightness()")}}
  - : Makes the image brighter or darker.
- {{cssxref("filter-function/contrast", "filter-function/contrast()", "contrast()")}}
  - : Increases or decreases the image's contrast.
- {{cssxref("filter-function/drop-shadow", "filter-function/drop-shadow()", "drop-shadow()")}}
  - : Applies a drop shadow behind the image.
- {{cssxref("filter-function/grayscale", "filter-function/grayscale()", "grayscale()")}}
  - : Converts the image to grayscale.
- {{cssxref("filter-function/hue-rotate", "filter-function/hue-rotate()", "hue-rotate()")}}
  - : Changes the overall hue of the image.
- {{cssxref("filter-function/invert", "filter-function/invert()", "invert()")}}
  - : Inverts the colors of the image.
- {{cssxref("filter-function/opacity", "filter-function/opacity()", "opacity()")}}
  - : Makes the image transparent.
- {{cssxref("filter-function/saturate", "filter-function/saturate()", "saturate()")}}
  - : Super-saturates or desaturates the input image.
- {{cssxref("filter-function/sepia", "filter-function/sepia()", "sepia()")}}
...
- {{cssxref("color_value/color", "color_value/color()", "color()")}} {{Experimental_Inline}}
...
- {{cssxref("color_value/color-mix", "color_value/color-mix()", "color-mix()")}} {{Experimental_Inline}}
  - : Takes two {{cssxref("color_value","color")}} values and returns the result of mixing them in a given colorspace by a given amount.
- {{cssxref("color_value/color-contrast", "color_value/color-contrast()", "color-contrast()")}} {{Experimental_Inline}}
...
- {{cssxref("color_value/device-cmyk", "color_value/device-cmyk()", "device-cmyk()")}} {{Experimental_Inline}}
  - : Used to express CMYK colors in a device-independent way.
- {{cssxref("color_value/hsl", "color_value/hsl()", "hsl()")}}
...
- {{cssxref("color_value/hsla", "color_value/hsla()", "hsla()")}}
...
- {{cssxref("color_value/rgba", "color_value/rgba()", "rgba()")}}
...
- {{cssxref("gradient/conic-gradient", "gradient/conic-gradient()", "conic-gradient()")}}
  - : Conic gradients transition colors progressively around a circle.
- {{cssxref("image/image", "image/image()","image()")}} {{Experimental_Inline}}
...
- {{cssxref("image/image-set", "image/image-set()","image-set()")}} {{Experimental_Inline}}
...
- {{cssxref("gradient/linear-gradient", "gradient/linear-gradient()","linear-gradient()")}}
  - : Linear gradients transition colors progressively along an imaginary line.
- {{cssxref("gradient/radial-gradient", "gradient/radial-gradient()","radial-gradient()")}}
  - : Radial gradients transition colors progressively from a center point (origin).
- {{cssxref("gradient/repeating-linear-gradient", "gradient/repeating-linear-gradient()","repeating-linear-gradient()")}}
...
- {{cssxref("gradient/repeating-radial-gradient", "gradient/repeating-radial-gradient()","repeating-radial-gradient()")}}
...
- {{cssxref("gradient/repeating-conic-gradient", "gradient/repeating-conic-gradient()","repeating-conic-gradient()")}}
...
- {{cssxref("font-variant-alternates/stylistic", "font-variant-alternates/stylistic()", "stylistic()")}}
...
- {{cssxref("font-variant-alternates/styleset", "font-variant-alternates/styleset()", "styleset()")}}
...
- {{cssxref("font-variant-alternates/character-variant", "font-variant-alternates/character-variant()", "character-variant()")}}
...
- {{cssxref("font-variant-alternates/swash", "font-variant-alternates/swash()", "swash()")}}
...
- {{cssxref("font-variant-alternates/ornaments", "font-variant-alternates/ornaments()", "ornaments()")}}
...
- {{cssxref("font-variant-alternates/annotation", "font-variant-alternates/annotation()", "annotation()")}}
