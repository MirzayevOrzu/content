...
- An image denoted by the {{CSSxRef("url", "url()", "url()")}} data type
- A {{CSSxRef("&lt;gradient&gt;")}} data type
- A part of the webpage, defined by the {{CSSxRef("element", "element()","element()")}} function
- An image, image fragment or solid patch of color, defined by the {{CSSxRef("image/image", "image/image()","image()")}} function
- A blending of two or more images defined by the {{CSSxRef("cross-fade", "cross-fade()","cross-fade()")}} function.
- A selection of images chosen based on resolution defined by the {{CSSxRef("image/image-set", "image/image-set()","image-set()")}} function.
