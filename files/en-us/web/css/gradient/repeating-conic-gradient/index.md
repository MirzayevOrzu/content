...
> **Note:** To create a conic gradient that does not repeat, make the gradient a full 360 degree rotation, or use the {{cssxref("gradient/conic-gradient", "gradient/conic-gradient()", "conic-gradient()")}} function instead.

### Understanding repeating conic gradients

The repeating-conic-gradient syntax is similar to the {{cssxref("gradient/conic-gradient", "gradient/conic-gradient()", "conic-gradient()")}} and {{cssxref("gradient/repeating-radial-gradient", "gradient/repeating-radial-gradient()", "repeating-radial-gradient()")}} syntax. Like the non-repeating conic-gradient, the color-stops are placed around a gradient arc. Like the repeating radial gradient, the size of the repeating section is the first color stop subtracted from the angle of the last color stop.
...
- Other gradient functions: {{cssxref("gradient/conic-gradient", "gradient/conic-gradient()", "conic-gradient()")}}, {{cssxref("gradient/linear-gradient", "gradient/linear-gradient()", "linear-gradient()")}}, {{cssxref("gradient/repeating-linear-gradient", "gradient/repeating-linear-gradient()", "repeating-linear-gradient()")}}, {{cssxref("gradient/radial-gradient", "gradient/radial-gradient()", "radial-gradient()")}}, {{cssxref("gradient/repeating-radial-gradient", "gradient/repeating-radial-gradient()", "repeating-radial-gradient()")}}
- {{cssxref("&lt;image&gt;")}}
