...
To create a linear gradient that repeats so as to fill its container, use the {{cssxref("gradient/repeating-linear-gradient", "gradient/repeating-linear-gradient()", "repeating-linear-gradient()")}} function instead.
...
- Other gradient functions: {{cssxref("gradient/repeating-linear-gradient", "gradient/repeating-linear-gradient()", "repeating-linear-gradient()")}}, {{cssxref("gradient/radial-gradient", "gradient/radial-gradient()", "radial-gradient()")}}, {{cssxref("gradient/repeating-radial-gradient", "gradient/repeating-radial-gradient()", "repeating-radial-gradient()")}}, {{cssxref("gradient/conic-gradient", "gradient/conic-gradient()", "conic-gradient()")}}, {{cssxref("gradient/repeating-conic-gradient", "gradient/repeating-conic-gradient()", "repeating-conic-gradient()")}}
- {{CSSxRef("&lt;image&gt;")}}
