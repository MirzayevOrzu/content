...
- {{cssxref("&lt;basic-shape&gt;")}}
  - : The float area is computed based on the shape created by of one of {{cssxref("basic-shape/inset", "basic-shape/inset()","inset()")}}, {{cssxref("basic-shape/circle", "basic-shape/circle()","circle()")}}, {{cssxref("basic-shape/ellipse", "basic-shape/ellipse()","ellipse()")}},  {{cssxref("basic-shape/polygon", "basic-shape/polygon()","polygon()")}} or, as added in the level 2 specification, `path()`. If a `<shape-box>` is also supplied, it defines the reference box for the `<basic-shape>` function. Otherwise, the reference box defaults to `margin-box`.
- {{cssxref("&lt;image&gt;")}}
